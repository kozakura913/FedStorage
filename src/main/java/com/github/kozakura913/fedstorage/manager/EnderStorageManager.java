package com.github.kozakura913.fedstorage.manager;

import com.github.kozakura913.fedstorage.FedStorage;
...
public class EnderStorageManager {
    ...
    public void storageList(ArrayList<AbstractEnderStorage> list) {
