package com.github.kozakura913.fedstorage.client.render.tile;

import com.github.kozakura913.fedstorage.EnderStorage;
import com.github.kozakura913.fedstorage.api.Frequency;
import com.github.kozakura913.fedstorage.client.model.ButtonModelLibrary;
...
public class RenderTileEnderTank extends TileEntitySpecialRenderer<TileEnderTank> {
    ...
    public static void loadModel() {
        ...
        initialized = true;
        Map<String, CCModel> models = OBJParser.parseModels(new ResourceLocation("fedstorage", "models/endertank.obj"), new SwapYZ());
    ...
    public static void renderLiquid(FluidStack liquid, double x, double y, double z) {
        RenderUtils.renderFluidCuboidGL(liquid, new Cuboid6(0.22, 0.12, 0.22, 0.78, 0.121 + 0.63, 0.78).add(new Vector3(x, y, z)), liquid.amount / (double)tankSize, 0.75);
    }
