	...
	public void handlePacket(PacketCustom packet, Minecraft mc, INetHandlerPlayClient handler) {
		switch (packet.getType()) {
			...
			case 2:
				...
				((EnderItemStorage) EnderStorageManager.instance(true).getStorage(Frequency.readFromPacket(packet), "item")).openClientGui(windowID, mc.player.inventory, packet);
				break;
			case 3:
			...
			case 6:
				...
				break;
			case 10:
				((EnderItemStorage) EnderStorageManager.instance(true).getStorage(Frequency.readFromPacket(packet), "item")).lastServerRejects=packet.readInt();
				break;
		}
	}
